...
static NSString * const kAppKey             = @"huanXinAppKey";
static NSString * const kCustomerName       = @"huanXinCustomerNameKey";
static NSString * const kCustomerNickname   = @"huanXinCustomerNickname";
static NSString * const kCustomerTenantId   = @"huanXinCustomerTenantId";
static NSString * const kCustomerProjectId  = @"huanXinCustomerProjectId";

static NSString * const hxPassWord = @"123456";
...
- (NSString *)appkey {
  ...
  if ([apk length] == 0) {
    apk = @"1418190710068439#kefuchannelapp72926";
...
- (NSString *)getRandomUsername {
    ...
    username = [username stringByAppendingString:[NSString stringWithFormat:@"ios%u",arc4random()%100000]];
    return username;
}
